...
var DiffButton = /*#__PURE__*/function (_Button) {
  ...
  _proto.view = function view() {
    var attrs = Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, this.attrs);
  ...
  _proto.getButtonContent = function getButtonContent() {
    ...
    flarum_utils_extractText__WEBPACK_IMPORTED_MODULE_7___default()(app.translator.trans('the-turk-diff.forum.createdInfo', {
      ...
      ago: flarum_helpers_humanTime__WEBPACK_IMPORTED_MODULE_6___default()(this.attrs.postDate)
    })) :
    /* {username} edited {ago} */
    ...
    revision.deletedAt() && this.attrs.subButton === false ? flarum_helpers_icon__WEBPACK_IMPORTED_MODULE_4___default()('fas fa-caret-down', {
...
var DiffDropdown = /*#__PURE__*/function (_Dropdown) {
  ...
  DiffDropdown.initAttrs = function initAttrs(props) {
    _Dropdown.initAttrs.call(this, props);
  ...
  _proto.getButtonContent = function getButtonContent() {
    return [flarum_helpers_icon__WEBPACK_IMPORTED_MODULE_3___default()(this.attrs.icon, {
  ...
  _proto.getMenu = function getMenu() {
    ...
    }, m("h4", null, app.translator.transChoice('the-turk-diff.forum.revisionInfo', this.attrs.post.revisionCount(), {
      ...
      return items.map(function (item) {
        ...
        var diffButton = _DiffButton__WEBPACK_IMPORTED_MODULE_3__["default"].component({
          ...
          onclick: function onclick() {
            if (!item.deletedAt()) {
              flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.modal.show(_DiffModal__WEBPACK_IMPORTED_MODULE_4__["default"], {
                item: item,
                post: _this.post,
          ...
          oncreate: function oncreate(vnode) {
            return Object(_utils_touchDevice__WEBPACK_IMPORTED_MODULE_7__["default"])() === false ? $(vnode).tooltip({
              trigger: 'hover',
              placement: 'left',
              container: 'body'
...
var DiffModal = /*#__PURE__*/function (_Modal) {
  ...
  _proto.view = function view() {
    ...
    }, flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('the-turk-diff.forum.deleteButton')) : '') : '', m("div", {
  ...
  _proto.content = function content() {
    ...
    return [m("div", {
      ...
      oncreate: function oncreate(elm) {
        return Object(_utils_touchDevice__WEBPACK_IMPORTED_MODULE_8__["default"])() === false ? $(elm).parent().tooltip({
          trigger: 'hover'
        }).data('bs.tooltip').tip().addClass(tooltipClass) : '';
      }
    })), m("div", {
    ...
    }, (_DiffList__WEBPACK_IMPORTED_MODULE_13__["default"], {
      post: this.post,
      forModal: true,
...
flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.initializers.add('the-turk/diff', function () {
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_1__["extend"])(flarum_components_CommentPost__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'headerItems', function (items) {
    ...
    if (this.isEditing() && flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.cache.diffs && flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.cache.diffs[this.attrs.post.id()]) {
      delete flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.cache.diffs[this.attrs.post.id()];
    }
  }); // prevent dropdown from closing when user
  // clicks on deleted diff

  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_1__["extend"])(flarum_components_DiscussionPage__WEBPACK_IMPORTED_MODULE_7___default.a.prototype, 'oninit', function () {
    var $body = $('body');
