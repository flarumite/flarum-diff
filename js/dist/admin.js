...
flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.initializers.add('the-turk-diff', function (app) {
  ...
  app.extensionSettings['the-turk-diff'] = function () {
    return app.modal.show(_modals_DiffSettingsModal__WEBPACK_IMPORTED_MODULE_3__["default"]);
  };
...
var DiffSettingsModal = /*#__PURE__*/function (_SettingsModal) {
  ...
  _proto.form = function form() {
    ...
    }, flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans(localePrefix + 'mainPostOnly')))]), m('.Form-group', [m('label', flarum_components_Switch__WEBPACK_IMPORTED_MODULE_4___default.a.component({
      state: this.setting(settingsPrefix + 'separateBlock', '1')() === '1',
      onchange: function onchange(value) {
        _this.setting(settingsPrefix + 'separateBlock')(value ? '1' : '0');
      }
    }, flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans(localePrefix + 'separateBlock')))]), m('.Form-group', [m('label', flarum_components_Switch__WEBPACK_IMPORTED_MODULE_4___default.a.component({
      state: this.setting(settingsPrefix + 'textFormatting', '1')() === '1',
      onchange: function onchange(value) {
        _this.setting(settingsPrefix + 'textFormatting')(value ? '1' : '0');
      }
    }, flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans(localePrefix + 'textFormatting')))]), m('.Form-group', [m('label', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans(localePrefix + 'detailLevel')), m('div', flarum_components_Select__WEBPACK_IMPORTED_MODULE_3___default.a.component({
      options: {
    ...
    }, flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans(localePrefix + 'archiveOlds'))), m('div', {
      className: 'helpText'
    ...
    }, flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans(localePrefix + 'useCrons'))), m('div', {
      className: 'helpText'
    }, m('i', {
      className: 'diffSettingsIcon fas fa-exclamation-circle'
